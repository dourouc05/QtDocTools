...
"""
This script runs qdoc to generate a XML-formatted version of the documentation in input. Untested. 
"""
...
if __name__ == '__main__':
    ...
    print("Time to generate HTML files: %f s" % (time_end - time_prepare))
