...
class QtModules {
    ...
    static List<String> ignoredModules; // A list of modules that have no documentation, and should thus be ignored.
    ...
    static Map<String, List<Pair<String, String>>> submodulesSpecificNames; // First-level folders in the source code
    ...
    static Map<String, Pair<Path, String>> qtTools; // Qt Tools follows no other pattern.
    static Map<String, Pair<Path, String>> qtBaseTools; // Qt Tools follows no other pattern, even within Qt Base.
