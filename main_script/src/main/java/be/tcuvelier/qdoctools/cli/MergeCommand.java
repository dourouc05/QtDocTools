...
@Command(name = "merge", description = "Perform merges between files, especially after " +
        "proofreading")
public class MergeCommand implements Callable<Void> {
    ...
    @Option(names = {"-t", "--type"},
            description = "Type of merge to perform. Allowed values: ${COMPLETION-CANDIDATES}. " +
                    ...
                    "AFTER_PROOFREADING should be used after a proofreading step: the metadata is" +
                    " supposed to be " +
                    ...
                    " " +
                    "some methods could have been added, their documentation rewritten, their " +
                    "order changed; " +
                    "the original document is the old version, the altered one the new version, " +
                    "the result will " +
                    "highlight the differences using the \"revisionflag\" DocBook attribute (new " +
                    "parts will be " +
                    "indicated by \"added\", changed ones will be marked as \"changed\"). \n" +
                    "UPDATE_QT_TRANSLATION works on the same document, but the original file has " +
                    "an old translation " +
                    "and the altered one corresponds to a newer version of Qt, has not been " +
                    "translated, and has been " +
                    "processed by UPDATE_QT to mark the modifications; afterwards, the " +
                    "differences will be " +
                    "highlighted using the \"revisionflag\" DocBook attribute (new parts will be " +
                    "indicated by " +
    ...
    @Override
    public Void call() throws SaxonApiException, MalformedURLException, FileNotFoundException,
